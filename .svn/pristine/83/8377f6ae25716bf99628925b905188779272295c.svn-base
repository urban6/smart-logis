...
<script type="text/javascript">
	...
	function goModifyLevel()
	{
		...
		$( "#menu" ).attr( "action" , "/management/operation/userlevel/moveModify" );
		$( "#menu" ).submit();
	...
	<form id="menu" name="menu" commandName="menu" method="post">
		<div class="row">
			<div class="col-lg-3 col-md-4 col-xs-12 align-self-center">
				<h5 class="font-medium text-uppercase mb-0">상세 정보</h5>
			</div>
	...
	<div class="col-lg-12 col-md-12">
						...
						<div class="myadmin-dd-empty dd" id="nestable">
							<ol class="dd-list">
								<li class="dd-item" data-id="0">
									...
									<input type="text" class="form-control" id="leveltitle" name="leveltitle" readonly="readonly" value="${list.leveltitle}"  placeholder="" />
								</li>
							</ol>
						</div>
					</div>
						...
						<div class="myadmin-dd-empty dd" id="nestable2">
							<ol class="dd-list">
								<li class="dd-item dd3-item" data-id="0">
									...
									<input type="text" class="form-control" id="leveltitle" name="leveltitle"  readonly="readonly" value="${list.description}"  placeholder="" />
								</li>
							</ol>
						</div>
					</div>
								...
								<div class="dd-handle">
									<div class="input-group mb-12">
										...
										<div class="input-group-append" style="padding: 10px 0 0 16px;">
											...
											<input dir="rtl" type="checkbox" style="float: right;" id="chk_use" name="chk_use"  disabled="disabled"  value="${menu1Depth.MENU_ID}" ${menu1Depth.LEVEL_ID  ne ''  ? 'checked="checked"' : ''}>
												...
												<div class="dd-handle">
													<div class="input-group mb-12">
														...
														<div class="input-group-append" style="padding: 10px 0 0 16px;">
															...
															<input dir="rtl" type="checkbox" style="float: right;" id="chk_use" name="chk_use" disabled="disabled"  value="${menu2Depth.MENU_ID}" ${menu2Depth.LEVEL_ID  ne ''  ? 'checked="checked"' : ''}>
			...
			<div class="modal-dialog" aria-labelledby="vcenter">
				<div class="modal-content">
					...
					<div class="modal-footer" id="modalConfirmDel">
						<button type="button" class="btn btn-secondary waves-effect" data-dismiss="modal">취소</button>
						<button type=button class="btn btn-primary waves-effect waves-light" data-dismiss="modal" onclick="javascript:fnRemoveAction();">확인</button>
					</div>
				</div>
			</div>
		</div>
		...
		<div class="card" style="background: none;">
			<div class="card-body" style="padding: 0;">
				<button class="btn waves-effect waves-light btn-secondary" onclick="goList()">목록</button>
				<button class="btn waves-effect waves-light btn-primary float-right" onclick="goModifyLevel()">정보 수정</button>
				<!-- <button class="btn waves-effect waves-light btn-primary float-right"   onclick="fnRemove()" >삭제</button> -->
			</div>
		</div>
