...
public class EncryptUtil {
	...
	private static String[]	_encChar	= { "ht3GHw7foFbjPzVD+deqkYQ9g4A1BOxEZI/mrac6NSui=U2LJsTWpCRl8nMK5vX0y" , "z01SEAwxcM3=TFPlm4Da+OKJnoijkCb2/pqVQR78NhIuL9WUstHBydv6grXYZG5ef" ,
			"ygJc1/TQe3C7rf4bSYoRl8vLAx+d=9h60wMm2OaK5uEZDHjsXkBWUFGpPNzqiIntV" , "PzVLJWu5poYQxh1Bnm4tb2gXijKRZc6Dyf+aU0AE=78/deHkOvwl9GS3NrqFsTICM" ,
			"/NygJsXkBRl8vr3CuEZGpPf4bSY7=V9hLAx1TWjInzU2OaK5oQeqMmt+dic60wFDH" , "ab2Dyl9rFQZK78/0AEBc6noYvMxhm4Gftq3NLJWdeHwzVgX=ijkOsTICR+UPu5p1S" ,
			"oY9gRmfQZliU2ICvX0AEK1BN5rLJsT=Wpnac6MS3+deqkGHw78/OxyuFbjPzVD4ht" , "stHACREB6nox+UPylwm4GcMN=L5pqVgXYZab2DIu/3OK789rFQhijkz01STvJWdef" ,
			"3GToFbmU2L+deqkpCu=iK5JsXz/Nygx1BRl8nDHw7V9htMSWjPQvOac6AY0EZIf4r" , "UG5po0AE78/deHwsTKac6nh1BrLJWFbQx=2DijPzVf+uY9gRyqkOvXZlICMS3Nm4t" };
	...
	public static String decode( String encWord ) {
		...
		for ( int i = 0 ; i < _encKeyCd.length ; i++ ) {
			if ( _encKeyCd[ i ].equals(encWord.substring(0 , 2)) ) {
				keyCd = i;
				break;
			}
		}
	...
	public static String decryptRsa( PrivateKey privateKey , String securedValue ) {
		...
		try {
			...
			result = new String(decryptedBytes, "utf-8"); // 문자 인코딩 주의.
