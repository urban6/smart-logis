...
<script type="text/javascript">
    ...
    //file 처리 ed------------->
 	...
 	function goSave() {
 		...
 		if(!hasErrorMessage()) {
 			openConfirmModal('관리자 등록', '저장하시겠습니까?', function() {		
 				showLoading();
		    	var param = new Object();
...
<section id="content" class="w1200">
	<article class="admin_conf">
		<form id="myForm" name="myForm" method="POST" class="valid_form">	
			...
			<input type="hidden" id="level_clcd" name="level_clcd" value="${partnerAdminDomain.level_clcd}" />
