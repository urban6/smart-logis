    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $("#WarehouseSearch").click(function (key) {
                movePage("POST", "/order/WarehouseSearch");
            });
                     	
            // 물류신청내역 조회
            $("#LogisSearch").click(function (key) {
                movePage("POST", "/order/LogisSearch");
            });

            // 주문내역 조회
            $("#OrderSearch").click(function (key) {
                movePage("POST", "/order/OrderSearch");
            });
        });
...
<div id="wrap">
    <div class="header">
        <div class="topTitle">
            <div class="title"><a href="/order/index">물류 공유해</a></div>
        </div>        
    </div>
    <div class="section">
        <div class="half-box" style="background-color: #FFFFFF">
            <div class="btn-container">                
                <div id="WarehouseSearch" class="btn-item">
                    ...
                    <div class="div-text">
                        <span class="span-title">창고신청내역 조회</span>
                    </div>
                </div>
            </div>
        </div>
        <div class="half-box" style="background-color: #FFFFFF">
            <div class="btn-container">
                <div id="LogisSearch" class="btn-item">
                    ...
                    <div class="div-text">
                        <span class="span-title">물류신청내역 조회</span>
                    </div>
                </div>
                <div id="OrderSearch" class="btn-item">
                	<div class="div-icon">
                        <img src="/images/logis_icon.png" width="70">
                    </div>
                    <div class="div-text">
                        <span class="span-title">주문내역 조회</span>
                    </div>
                </div>
            </div>
        </div>
