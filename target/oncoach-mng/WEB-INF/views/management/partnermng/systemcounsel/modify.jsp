						...
						<colgroup>
			          	...
			          	<tbody>
							<tr>
								...
								<td>
									<input type="text" class="inp_txt w540" id="counsel_title" name="counsel_title" placeholder="" maxlength="100" value="${info.counsel_title}" />
				                </td>
				            </tr>
							<tr>
									...
									<div class="sel_box">
										...
										<ul class="img_area clearfix" >
								        	<c:if test="${info.counsel_img_file_sno_1 ne null && info.counsel_img_file_sno_1 ne 0   }">
								        		<li>
								        			<a href='javascript:void(0);' onclick='deleteImageAction($(this));' class='btn_rmv'>×</a>
								        			<input type="hidden" name="attach_file_list" value="${info.counsel_img_file_sno_1}">
								        	...
								        	<c:if test="${info.counsel_img_file_sno_2 ne null && info.counsel_img_file_sno_2 ne 0   }">
								        		<li>
								        			<a href='javascript:void(0);' onclick='deleteImageAction($(this));' class='btn_rmv'>×</a>
								        			<input type="hidden" name="attach_file_list" value="${info.counsel_img_file_sno_2}">
								        	...
								        	<c:if test="${info.counsel_img_file_sno_3 ne null && info.counsel_img_file_sno_3 ne 0   }">
								        		<li>
								        			<a href='javascript:void(0);' onclick='deleteImageAction($(this));' class='btn_rmv'>×</a>
								        			<input type="hidden" name="attach_file_list" value="${info.counsel_img_file_sno_3}">
			...
			<div class="btn_area">
				<div class="center">
					...
					<shovvel:auth auth="${authType}">
						<c:if test="${sessionUser.userSno eq info.ins_user_sno}">   
