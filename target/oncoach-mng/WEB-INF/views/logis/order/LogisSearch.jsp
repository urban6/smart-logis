    ...
    <script type="text/javascript">
        ...
        function compareDate() {
            ...
            if (start.getTime() > end.getTime()) {
                ...
                alert("출발일자와 도착일자를 확인해 주시기 바랍니다.");
        ...
        function getLogisList() {
        	
        	NProgress.start();

        	 $.ajax("/order/LogisList",
        			 
                     {
                         ...
                         dataType: 'JSON'
                          ...
                          if (list.length === 0) {
                              ...
                              logisStr += '<div style="text-align: center; padding: 5%"><span class="span-empty">조회된 데이터가 없습니다.</span></div>';
                          ...
                          $.each(list, function (i) {
                                  ...
                                  logisStr +=
                                      ...
                                      '<div><span class="span-requestdate">' + list[i].startTime + ' ~ ' + list[i].arriveTime + '</span></div>' +
                          ...
                          $("#list").find('input').click(function (data) {
                              ...
                              getLogisDetail(list[index].logisOrderUid);
         ...
         * 주문 상세 내역 호출
         * */
        function getLogisDetail(uid) {
        	            
            const logisOrderUid = document.createElement('input');
            
            logisOrderUid.setAttribute("name", "logisOrderUid");
            logisOrderUid.setAttribute("value", uid);
            
            const form = document.createElement('form');
            
            form.setAttribute('method', 'POST');
            form.setAttribute('action', '/order/LogisDetail');
    ...
    <div class="section">
        <div class="div-search-box">           
                <div class="div-date-box">
                    <div class="div-date">
                        <div class="form-group mr-3">
                            <label for="startDate" class="col-form-label label-title">출발일자</label>
                            <input class="form-control" type="date" id="startDate" max="9999-12-31">
                        </div>                    	
                    </div>
                    <div class="div-date mr-3">
                        <div class="form-group">
                            <label for="endDate" class="col-form-label label-title">도착일자</label>
                ...
                <div class="div-confirm-box">
                    <input id="btnSearch" type="submit" class="btn btn-logis-primary" onclick="getLogisList()" style="width: 100%" value="조회">
                </div>
        </div>
